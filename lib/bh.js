    ...
    this.utils = {
        ...
        mod: function(key, value, force) {
            ...
            if (value !== undefined) {
                ...
                if (mods[key] === undefined || dirtyEnv && !mods.hasOwnProperty(key) || force) mods[key] = value;
                return this;
            } else {
                mods = this.ctx.mods;
                return !mods || dirtyEnv && !mods.hasOwnProperty(key) ? undefined : mods[key];
            }
        },
        /**
        ...
        mods: function(values, force) {
            ...
            if (values !== undefined) {
                for (var key in values) {
                    ...
                    if (mods[key] === undefined || dirtyEnv && !mods.hasOwnProperty(key) || force) mods[key] = values[key];
                }
                return this;
            } else {
                return mods;
        ...
        attr: function(key, value, force) {
            ...
            if (value !== undefined) {
                ...
                if (attrs[key] === undefined || dirtyEnv && !attrs.hasOwnProperty(key) || force) attrs[key] = value;
                return this;
            } else {
                attrs = this.ctx.attrs;
                return !attrs || dirtyEnv && !attrs.hasOwnProperty(key) ? undefined : attrs[key];
            }
        },
        /**
